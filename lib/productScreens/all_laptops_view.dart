...
class allLaptops extends StatefulWidget {
  @override
  _allLaptopsState createState() => _allLaptopsState();
}

class _allLaptopsState extends State<allLaptops> {
  var documentID;
    ...
    return  MaterialApp(
      ...
      home: Scaffold(
        ...
        StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('Products').where('Product_Type', isEqualTo: 'Laptop').snapshots(),
